...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-f9n0qb8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-f9n0qb8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Hellraz00r23/container-f9n0qb8.git
cd container-f9n0qb8
```
...
```
docker attach container-f9n0qb8
```
